...
LOCALE = "en-US"
RECORDINGS_BLOB_URI = "https://callcenteranalytics.blob.core.windows.net/cc-stage0-recording/katiesteve.wav"
# RECORDINGS_BLOB_URI = None
...
MODEL_REFERENCE = "69adf293-9664-4040-932b-02ed16332e00"  # guid of a Whisper model
    ...
    while not completed:
        ...
        if transcription.status == "Succeeded":
            ...
            for file_data in _paginate(api, pag_files):
                ...
                with open(f"{audiofilename}.json", "w", encoding="utf-8") as f:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-f', '--filesas', type=str, required=False, help='The SAS URL to MP3 file')

    args = parser.parse_args()

    # RECORDINGS_BLOB_URI = args.filesas
